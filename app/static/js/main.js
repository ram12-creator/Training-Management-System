...
//             // **THE FIX**: Only proceed if the href is a valid selector (more than just #)
//             if (href && href.length > 1) {
//                 try {
//                     const target = document.querySelector(href);
//                     if (target) {
//                         e.preventDefault(); // Only prevent default if we are actually scrolling
//                         target.scrollIntoView({
//                             behavior: 'smooth',
//                             block: 'start'
//                         });
//                     }
//                 } catch (error) {
//                     // This will catch any other invalid selector errors, preventing a crash.
//                     console.error("Smooth scroll failed: Invalid selector", href);
//                 }
//             }
//         });
...
//                 console.log('PDF export requires additional libraries');
//                 break;
//         }
//     };
...
//     // FIX: Corrected Performance monitoring
//     if ('performance' in window) {
//         window.addEventListener('load', function() {
//             const perfEntries = performance.getEntriesByType("navigation");
//             if (perfEntries.length > 0) {
...
//     // FIX: Add this block to fix the aria-hidden focus warning for all modals
//     const modals = document.querySelectorAll('.modal');
//     modals.forEach(modal => {
//         modal.addEventListener('hidden.bs.modal', function (event) {
//             // Using a try-catch because relatedTarget can sometimes be null
//             try {
//                 const trigger = event.relatedTarget;
//                 if (trigger) {
//                     trigger.blur();
//                 }
//             } catch (error) {
//                 // Do nothing, just prevent a crash
//             }
//         });
//     });
// });
...
//     // CORRECTED: Improved Global error handler
//     window.addEventListener('error', function(e) {
//         console.error('A global error occurred:', e.message, 'in', e.filename, 'at line', e.lineno);
//     });

//     // CORRECTED: Modern Performance monitoring
//     if ('performance' in window && performance.getEntriesByType) {
//         window.addEventListener('load', function() {
//             const perfEntries = performance.getEntriesByType("navigation");
//             if (perfEntries.length > 0) {
...
//     // CORRECTED: Fix for the aria-hidden focus warning on all modals
//     const modals = document.querySelectorAll('.modal');
//     modals.forEach(modal => {
//         modal.addEventListener('hidden.bs.modal', function (event) {
//             try {
...
// // --- RESTORED: Global Utility Functions ---
...
//             break;
//         case 'pdf':
//             console.log('PDF export requires additional libraries like jsPDF');
